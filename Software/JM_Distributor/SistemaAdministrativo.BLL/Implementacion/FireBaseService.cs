...
namespace SistemaAdministrativo.BLL.Implementacion
{
    public class FireBaseService : IFireBaseService
    {
        ...
        public FireBaseService(IGenericRepository<Credencial> repositorio)
        {
        ...
        public async Task<string> SubirStorage(Stream StreamArchivo, string CarpetaDestino, string NombreArchivo)
        {
            ...
            try
            {
                IQueryable<Credencial> query = await _repositorio.Consultar(c => c.Recurso.Equals("FireBase_Storage"));
