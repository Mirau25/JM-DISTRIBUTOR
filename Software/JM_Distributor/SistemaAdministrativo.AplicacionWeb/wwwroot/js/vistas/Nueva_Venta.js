...
$(document).ready(function () {
    ...
    $("#txtDocumentoCliente").on("select2:select", function (e) {
        const data = e.params.data;
        clienteSeleccionado = data.text;
    });
    ...
    $("#txtDocumentoCliente").select2({
        ajax: {
            url: "/Cliente/BuscarPorDocumento",
            dataType: 'json',
            delay: 250,
            data: function (params) {
                return {
                    documentoCliente: params.term // Envía el término de búsqueda como documentoCliente
                };
            },
            processResults: function (data) {
                return {
                    results: $.map(data, function (item) {
                        return {
                            id: item.documentoCliente, // Usar el documento del cliente como ID
                            text: item.nombreCliente // Utiliza el nombre del cliente como texto
                        };
                    })
                };
            },
    ...
    $("#btnTerminarVenta").click(function () {
        ...
        // Validar que el nombre y el documento del cliente no estén vacíos
        if ($("#txtDocumentoCliente").val() === "" || $("#txtNombreCliente").val() === "") {
            toastr.warning("", "Debe ingresar el nombre y el documento del cliente");
            return;
        }
        ...
        fetch("/Venta/RegistrarVenta", {
            ...
            .then(responseJson => {
                if (responseJson.estado) {
                    ...
                    $("#txtNombreCliente").val(clienteSeleccionado);
