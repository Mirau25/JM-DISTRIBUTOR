...
namespace SistemaAdministrativo.AplicacionWeb.Utilidades.Automapper
{
    public class AutoMapperProfile : Profile  //Este Profile es de automapper
    {
        public AutoMapperProfile()
        {
            CreateMap<Cliente, VMCliente>()
               ...
               );//Como es int y no booleano, tenemos que especificar la lógica.
