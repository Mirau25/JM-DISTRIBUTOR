...
namespace SistemaAdministrativo.DAL.DBContext
{
    public partial class DBJMContext : DbContext
    {
        public DBJMContext()
        {
        }

        public DBJMContext(DbContextOptions<DBJMContext> options)
            : base(options)
        {
        }
        ...
        public virtual DbSet<NumeroVenta> NumeroVentas { get; set; } = null!;
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.HasKey(e => e.IdNumeroVenta)
                    .HasName("PK__NumeroCo__25FB547EF83526BF");

                entity.ToTable("NumeroVenta");

                entity.Property(e => e.IdNumeroVenta).HasColumnName("idNumeroVenta");
            ...
            modelBuilder.Entity<Cliente>(entity =>
            {
                entity.HasKey(e => e.IdCliente)
                    .HasName("PK_Cliente_885457EEB34FB075");
